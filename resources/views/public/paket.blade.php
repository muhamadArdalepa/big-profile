@extends('public.layouts.app') @push('css') @endpush @section('content')
        ...
        <div class="col-md-6 px-3 mb-3">
            <div class="d-flex gap-0 rounded-4 shadow-lg overflow-hidden">
                <div class="col-6 p-4 bg-white">
                    <div
                        class="d-flex gap-3 align-items-start flex-md-column justify-content-center"
                    >
                        <img
                            src="/images/logo/big-warna-full.png"
                            alt="logo bignet"
                            height="70"
                        />
                    ...
                    <div
                        class="d-flex mt-3 justify-content-between flex-md-column align-items-start gap-3"
                    >
                        <div class="text-start">
                            <div>
                                Up To
                                <strong class="text-danger"
                                    >{{$paket->kecepatan}} Mbps</strong
                                >
                            </div>
                        ...
                        <div class="mb-2">
                            <strong class="text-danger fw-bold display-5"
                                >{{$paket->harga}}rb</strong
                            >
                            /Bulan
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div class="d-flex gap-2 mb-2">
                            <div class="text-start text-danger">
                                <i
                                    class="fa-solid fa-circle-check fa-xl d-inline-block"
                                ></i>
                            </div>
                            <div class="text-start">
                                {{$paket->include}}
